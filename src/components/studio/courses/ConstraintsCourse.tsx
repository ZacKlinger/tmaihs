  ...
  const sections = [
  {
    ...
    <div className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <div className="bg-muted/50 p-6 rounded-lg border border-border/50 my-4">
            <p className="text-lg italic text-muted-foreground">It's Week 5 a hydroponics project in your SDC science classroom. Your students just finished their pH baseline readings and they're about to design their nutrient delivery systems. You need a worksheet that bridges the chemistry they've done with the biology they're starting — and you need it by eigh period.
