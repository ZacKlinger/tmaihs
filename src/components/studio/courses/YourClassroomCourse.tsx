  ...
  },
  {
    ...
    <div className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <ul>
            ...
            <li><strong>Chronic absenteeism:</strong>Device access: One-to-one Chromebooks, a shared cart, phones only, or paper-first? How often do students actually have a screen in front of them?
