...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-background via-background to-secondary/30 py-20 lg:py-32">
      <PhoenixArcs />
      ...
      <div className="section-container relative">
        <div className="mx-auto max-w-3xl text-center">
          ...
          {/* Main heading */}
          <h1 className="mb-6 font-serif text-4xl font-bold tracking-tight text-charcoal opacity-0 animate-fade-in sm:text-5xl lg:text-6xl" style={{ animationDelay: "0.1s" }}>
            AI Tools for{" "}
          ...
          {/* CTAs */}
          <div className="flex flex-col items-center justify-center gap-4 opacity-0 animate-fade-in sm:flex-row" style={{ animationDelay: "0.3s" }}>
          ...
          {/* Research note */}
          <p className="mt-12 text-sm text-muted-foreground opacity-0 animate-fade-in" style={{ animationDelay: "0.5s" }}>
